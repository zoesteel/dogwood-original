...
/*--------------------------------------
	Include Responsive Slider js and css
	------------------------------------*/

// wp_enqueue_style( 'responsiveslides-css', get_template_directory_uri() . '/css/responsiveslides.css',false,'1.1','all');

// wp_enqueue_script( 'responsiveslides-js', get_template_directory_uri() . '/js/responsiveslides.min.js', array ( 'jquery' ), 1.1, true);
